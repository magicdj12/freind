    ...
    try:
        try:
            ...
            return await CallbackQuery.answer(
                f"» من اجازه دعوت کردن کاربران را توسط لینک ندارم {CallbackQuery.message.chat.title}.",
                show_alert=True,
            )
        if get.status == ChatMemberStatus.BANNED:
            return await CallbackQuery.answer(
                text=f"»دستیار موزیک بند شده است  {CallbackQuery.message.chat.title}",
                show_alert=True,
            )
            ...
            try:
                ...
                try:
                    ...
                    return await CallbackQuery.message.reply_text(
                        f"دعوت دستیار صوتی به شکست مواجه شد {CallbackQuery.message.chat.title}\nدلیل  :{e}"
                    )
            except Exception as ex:

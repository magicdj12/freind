...
@app.on_message(filters.command(["vcmute","بیصدا"],prefixes=["", "/"]) & filters.group & ~BANNED_USERS)
@AdminRightsCheck
...
@app.on_message(filters.command(["vcunmute","صدا دار"],prefixes=["", "/"] ) & filters.group & ~BANNED_USERS)
@AdminRightsCheck

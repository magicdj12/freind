    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**ویس چت فعالی پیدا نشد**\n\nلطفا خودرا از تماس فعال مطما کنید ."
                )
        except Exception as e:
            ...
            raise AssistantErr(
                "**موزیک پلیر آماده پخش موزیک هست **\n\nربات ویس چت فعالی پیدا کرده در صورت پخش نشدن ویس چت را دوباره شورع کنید ."
            )
        except TelegramServerError:
            raise AssistantErr(
                "**مشکل سرور تلگرام**\n\nلطفا ویس چت را باز و بسته کنید "
            )
